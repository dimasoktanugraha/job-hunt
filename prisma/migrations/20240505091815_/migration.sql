...
-- AddForeignKey
ALTER TABLE "CompanyOverview" ADD CONSTRAINT "CompanyOverview_industryId_fkey" FOREIGN KEY ("industryId") REFERENCES "Industry"("id") ON DELETE SET NULL ON UPDATE CASCADE;
