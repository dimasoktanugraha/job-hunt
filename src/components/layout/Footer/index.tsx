...
const Footer : FC<FooterProps> = ({}) => {
  return (
    <div className='bg-slate-900 px-32 text-foreground pt-16 pb-10'>
        <div className='flex flex-row items-start justify-between'>
            <div>
                ...
                <div className='text-muted mt-8'>
                    ...
                    passionate about startup. Find your dream job <br />
                    easier.
                </div>
            </div>
            ...
            <div>
                <div className='text-lg text-foreground font-semibold mb-5'>
                    Get Job Notification
                </div>
                <div className='text-muted'>
                    The latest job's news, articles,sent to <br />your inbox weekly
                </div>
      ...
      <div className='flex flex-row items-center justify-between'>
        <div className='text-slate-600'>
            2021 @ Job Hunt. All rights reserved.
        </div>
