...
const JobItem: FC<JobItemProps> = ({ image, jobType, name, type, location, desc, category}) => {
  return (
    <div className='border border-border p-6 cursor-pointer'>
      ...
      <div className='my-4'>
        ...
        <div className='text-muted-foreground h-12 line-clamp-2 text-ellipse' dangerouslySetInnerHTML={{ __html: desc}}>
        </div>
      </div>
